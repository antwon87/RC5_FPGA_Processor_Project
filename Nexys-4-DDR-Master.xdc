...
#create_generated_clock -name clk -source [get_ports *sys_clk*] -divide_by 2 [get_pins clk_reg/Q]
...
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { rdy_led }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
